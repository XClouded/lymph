...
public class EPluginManifestUtil {
	...
	public static void setManifestInfo(Context context, String apkPath, EPluginItem info)
			throws XmlPullParserException, IOException {
		
		ZipFile zipFile = new ZipFile(new File(apkPath), ZipFile.OPEN_READ);
		ZipEntry manifestXmlEntry = zipFile.getEntry(EPluginManifestReader.DEFAULT_XML);
		
		String manifestXML = EPluginManifestReader.getManifestXMLFromAPK(zipFile,
				manifestXmlEntry);
...
//		}
	...
	private static void setAttrs(EPluginItem info, String manifestXML)
			throws XmlPullParserException, IOException {
	...
	private static void parseApplicationInfo(EPluginItem info,
	...
	private static void addActivity(EPluginItem info, String namespace,
	...
	private static void addService(EPluginItem info, String namespace,
			XmlPullParser parser) throws XmlPullParserException, IOException {
		int eventType = parser.getEventType();
	...
	private static void addReceiver(EPluginItem info, String namespace,
			XmlPullParser parser) throws XmlPullParserException, IOException {
		int eventType = parser.getEventType();
